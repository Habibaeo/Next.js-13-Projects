          ...
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill pr-1 /> React
              </p>

              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill pr-1 /> Tailwind
              </p>

              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill pr-1 /> JavaScript
              </p>

              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill pr-1 /> Firebase
              </p>

              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill pr-1 /> Google API
              </p>

              <p className="text-gray-600 py-2 flex items-center">
                <RiRadioButtonFill pr-1 /> Zillow API
              </p>
            </div>
          </div>
        </div>
